      ...
      <div class="col-md-10">
        ...
        <table cellpadding="2" cellspacing="2" border="2" class="table table-bordered">
              ...
              <?php
               ...
               $data = mysqli_query($link,"Select * from te_registration where username = '$username'");
               $row = mysqli_fetch_array($data);
               $id = $row['id'];

                $data = mysqli_query($link,"SELECT * FROM te_notice WHERE id = '$id' limit 3");  //mysql query for specific username            
                     if($data === FALSE) { 
